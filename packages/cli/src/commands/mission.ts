...
export function registerMissionCommands(program: any) {
  ...
  mission.command('list')
    ...
    .action(withErrorHandling(async (habitatId: string, options: { status?: string; priority?: string; isArchived?: boolean; limit: string }) => {
  ...
  mission.command('create')
    ...
    .action(withErrorHandling(async (habitatId: string, title: string, options: any) => {
