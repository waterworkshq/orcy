...
describe("NotificationDropdown", () => {
  ...
  it("shows unread dot for unread notifications", () => {
    notificationsState = [makeNotification({ id: "n1", read: false })];
  ...
  it("hides unread dot for read notifications", () => {
    notificationsState = [makeNotification({ id: "n1", read: true })];
  ...
  it("shows agent name in notification", () => {
    notificationsState = [makeNotification({ id: "n1", agentName: "Bot-42", message: "Done" })];
  ...
  it("displays notifications in reverse chronological order", () => {
    notificationsState = [
      makeNotification({
        id: "new",
        taskTitle: "Newest",
        timestamp: new Date("2026-01-02").toISOString(),
      }),
      makeNotification({
        id: "old",
        taskTitle: "Oldest",
