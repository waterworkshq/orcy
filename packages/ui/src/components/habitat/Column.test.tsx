...
describe("Column", () => {
  ...
  it("renders column name", () => {
    render(<Column column={mockColumn} features={mockFeatures} onSettingsClick={vi.fn()} />);
  ...
  it("calls onSettingsClick when settings button clicked", () => {
    ...
    render(<Column column={mockColumn} features={mockFeatures} onSettingsClick={onSettings} />);
  ...
  it("shows claim badge when column requires claim", () => {
    ...
    render(<Column column={claimColumn} features={mockFeatures} onSettingsClick={vi.fn()} />);
