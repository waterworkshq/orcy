...
vi.mock("../../lib/useHabitatData.js", () => ({
  useAgents: () => ({ data: mockBoardState.agents as any[], isLoading: false, isError: false }),
}));
...
describe("TaskCard glass design system", () => {
  ...
  it("renders truncated task ID", () => {
    render(<TaskCard task={makeTask({ id: "task-b3f291e8-abcd", title: "ID Task" })} />);
...
describe("TaskCard filtered presence selector", () => {
  ...
  it("does not show viewer indicator when no viewers for this task", () => {
    mockBoardState.presence = [{ sessionId: "s1", viewingTaskId: "other-task", userName: "Alice" }];
