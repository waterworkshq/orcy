...
describe("BulkActionBar", () => {
  ...
  describe("Bulk Delete", () => {
    ...
    it("invalidates mission list cache after successful delete", async () => {
      render(<BulkActionBar habitatId="board-1" />);
      ...
      await waitFor(() => {
        expect(mockInvalidateQueries).toHaveBeenCalledWith({
          queryKey: ["missions", "list", "board-1"],
        });
      });
    });
  ...
  describe("Bulk Priority Change", () => {
    ...
    it("invalidates mission list cache after successful priority change", async () => {
  ...
  describe("Bulk Move", () => {
    ...
    it("invalidates mission list cache after successful move", async () => {
      const movedFeature = {
        id: "feat-1",
        columnId: "col-2",
        habitatId: "board-1",
  ...
  describe("Error Handling", () => {
    it("handles delete operation with error", async () => {
      // When delete fails, invalidateQueries should not be called
    ...
    it("handles update operation with error", async () => {
      // When update fails, invalidateQueries should not be called
