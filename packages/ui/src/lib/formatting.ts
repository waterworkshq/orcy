...
export const TASK_STATUS_VARIANT: Record<string, 'pending' | 'claimed' | 'in_progress' | 'submitted' | 'approved' | 'rejected' | 'done' | 'failed'> = {
  pending: 'pending',
  claimed: 'claimed',
...
export const FEATURE_STATUS_VARIANT: Record<string, string> = {
  not_started: 'pending',
  in_progress: 'in_progress',
  review: 'submitted',
  done: 'done',
