 ...
 * `cryptoRandom()` here and ignored by the receiver. `cryptoRandom` itself
 * is now dead code, scheduled for T8/T9 collapse alongside the other
 * dispatcher-owned lifecycle helpers (`startPluginRun`, `withTimeout`).
 */
