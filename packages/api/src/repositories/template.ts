...
export function seedGlobalTemplates(): void {
  ...
  const templates: Array<{
    ...
    },
    {
      ...
      titlePattern: "Deliver: {{mission_name}}",
      descriptionPattern:
      ...
      tasksTemplate: [
        {
          key: "build",
          title: "Build: {{mission_name}}",
          description: "Implement the {{mission_name}} feature.",
          order: 0,
        ...
        {
          key: "test",
          title: "Test: {{mission_name}}",
          description: "Write and run tests for {{mission_name}}.",
          order: 1,
          requiredDomain: "qa",
        ...
        {
          key: "review",
          title: "Review: {{mission_name}}",
          description: "Code review of the {{mission_name}} implementation.",
          order: 2,
        ...
        {
          key: "deploy",
          title: "Deploy: {{mission_name}}",
          description: "Deploy {{mission_name}} to production.",
          order: 3,
