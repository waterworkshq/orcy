...
import {
  clonePublicationSchema,
  type ClonePublicationInput,
...
export async function taskClonePublicationRoutes(
  ...
  fastify.withTypeProvider<ZodTypeProvider>().post(
    ...
    async (request, reply) => {
      ...
      const targetedAssignmentDeadline: string | undefined =
      ...
      const result = publishTaskCreation({
        ...
        ...(parsed.requiredDomain !== undefined
