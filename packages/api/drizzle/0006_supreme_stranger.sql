...
CREATE INDEX `idx_audit_schedules_board` ON `audit_export_schedules` (`habitat_id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `idx_health_snapshots_board` ON `habitat_health_snapshots` (`habitat_id`);--> statement-breakpoint
CREATE INDEX `idx_health_snapshots_time` ON `habitat_health_snapshots` (`habitat_id`,`snapshot_at`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `idx_mission_mentions_comment_id` ON `mission_comment_mentions` (`comment_id`);--> statement-breakpoint
CREATE INDEX `idx_mission_mentions_target` ON `mission_comment_mentions` (`mentioned_type`,`mentioned_id`);--> statement-breakpoint
CREATE UNIQUE INDEX `idx_mission_mentions_unique` ON `mission_comment_mentions` (`comment_id`,`mentioned_type`,`mentioned_id`,`mention_text`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `idx_mission_comments_mission_id` ON `mission_comments` (`mission_id`,`created_at`);--> statement-breakpoint
CREATE INDEX `idx_mission_comments_parent` ON `mission_comments` (`parent_id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `idx_scheduled_tasks_board` ON `scheduled_tasks` (`habitat_id`);--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_project_insights`("id", "habitat_id", "source_pulse_id", "source_mission", "signal_type", "subject", "body", "relevance_tags", "promoted_by", "promoted_at", "is_active", "created_at") SELECT "id", "habitat_id", "source_pulse_id", "source_mission", "signal_type", "subject", "body", "relevance_tags", "promoted_by", "promoted_at", "is_active", "created_at" FROM `project_insights`;--> statement-breakpoint
...
CREATE INDEX `idx_insights_board` ON `project_insights` (`habitat_id`);--> statement-breakpoint
...
ALTER TABLE `habitats` ADD `prioritization_settings` text;--> statement-breakpoint
CREATE INDEX `idx_missions_sla_deadline_at` ON `missions` (`sla_deadline_at`);--> statement-breakpoint
