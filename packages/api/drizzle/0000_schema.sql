...
--> statement-breakpoint
CREATE UNIQUE INDEX `idx_cumulative_flow_snapshot_unique` ON `cumulative_flow_snapshots` (`habitat_id`,`snapshot_date`);--> statement-breakpoint
CREATE INDEX `idx_cumulative_flow_snapshots_habitat_date` ON `cumulative_flow_snapshots` (`habitat_id`,`snapshot_date`);
