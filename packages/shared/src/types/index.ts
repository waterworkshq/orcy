...
export {
  ...
  EXTRACTION_WORK_STATUSES,
  EXTRACTION_ATTEMPT_STATUSES,
  EXTRACTION_DELIVERY_MODES,
  EXTRACTION_FINDING_TYPES,
  EXTRACTION_FINDING_COMPLETENESS,
  EXTRACTION_VISIBILITY_CLASSES,
  EXTRACTION_FINDING_STATUSES,
  EXTRACTION_CITATION_ROLES,
  EXTRACTION_SOURCE_COMPLETENESS,
  EXTRACTION_SCOPE_TYPES,
  EXTRACTION_REVIEW_DECISIONS,
  EXTRACTION_PROMOTION_DESTINATIONS,
  EXTRACTION_PROMOTION_STATUSES,
