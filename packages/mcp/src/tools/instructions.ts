...
- **orcy_admin** — admin operations (list-webhooks, create-webhook, delete-webhook, list-templates, create-template, delete-template, batch-assign-tasks, batch-set-priority, batch-delete-tasks, export-audit-log, get-audit-summary, list-scheduled-tasks, create-scheduled-task, run-scheduled-task, get-scheduled-task, update-scheduled-task, delete-scheduled-task, toggle-scheduled-task)
