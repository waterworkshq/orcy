...
export const TASK_STATUSES = ['pending', 'claimed', 'in_progress', 'submitted', 'approved', 'rejected', 'done', 'failed'] as const;
...
export const TASK_UPDATE_STATUSES = ['in_progress', 'submitted', 'approved', 'done', 'failed'] as const;
