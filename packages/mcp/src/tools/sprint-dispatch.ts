...
export const SPRINT_DISPATCH_TOOL: Tool = createDispatchTool({
  name: 'orcy_sprint',
  description: 'Sprint operations: list, get, get_active, create, update, delete, start, complete, cancel, add_mission, remove_mission',
  actions: ['list', 'get', 'get_active', 'create', 'update', 'delete', 'start', 'complete', 'cancel', 'add_mission', 'remove_mission'],
  sharedParams: {
    boardId: { type: 'string', description: 'Habitat UUID (used with list, get_active, create)' },
    sprintId: { type: 'string', description: 'Sprint UUID (used with get, update, delete, start, complete, cancel, add_mission, remove_mission)' },
    missionId: { type: 'string', description: 'Mission UUID (used with add_mission, remove_mission)' },
    ...
    capacityMinutes: { type: 'number', description: 'Sprint capacity in minutes (used with create, update)' },
